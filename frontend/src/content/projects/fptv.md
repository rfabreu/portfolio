...
FPTV needed a professional web presence that reflected their broadcasting quality while providing subscribers with an intuitive dashboard experience.

## Approach

Built custom frontend features using vanilla HTML, CSS, and JavaScript integrated with the Weebly (Square) platform. Focused on glassmorphism design for the subscriber dashboard and integrated the Environment Canada weather widget.
